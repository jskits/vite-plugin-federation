...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "react": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__reactHost__prebuild__react__prebuild__.js");
            return pkg;
        }
      ,
        "react-dom": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__reactHost__prebuild__react_mf_2_dom__prebuild__.js");
            return pkg;
        }
      ...
      const usedShared = {
          ...
          "react": {
            ...
            scope: ["default"],
            loaded: false,
            from: "__mfe_internal__reactHost",
            async get () {
              if (false) {
      ...
      const usedRemotes = [
                {
                  entryGlobalName: "http://localhost:4174/mf-manifest.json",
                  name: "reactRemote",
                  type: "var",
